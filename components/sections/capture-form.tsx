...
Email : ${data.email}${data.whatsapp ? `\nWhatsApp : ${data.whatsapp}` : ""}`;
  ...
  return (
    <section className="relative">
      ...
      <div
        aria-hidden
        className="absolute inset-x-0 top-0 h-[400px] bg-[radial-gradient(ellipse_70%_50%_at_50%_0%,rgba(184,134,11,0.06),transparent_70%)] pointer-events-none"
      />

      <div className="relative mx-auto max-w-2xl px-5 sm:px-6 pt-14 sm:pt-20 pb-16 sm:pb-20 lg:pt-24 lg:pb-24">
        {/* ============================================================
            EN-TÊTE
           ============================================================ */}
        ...
        {/* ============================================================
            FORMULAIRE — SANS CONTENEUR, CHAMPS ARRONDIS
           ============================================================ */}
        ...
        {/* ============================================================
           ...
           ============================================================ */}
        <div className="mt-14 pt-8 border-t border-[#E2E8F0] space-y-3 text-center">
